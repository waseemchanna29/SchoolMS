...
sessionStorage.removeItem('__THEME_CONFIG__')
 window.config = {
    ...
    window.defaultConfig = { ...window.config };
// Common
class App {
...
class LayoutCustomizer {
  ...
  initConfig() {
    ...
    html.setAttribute('data-skin',              this.config['skin'])
    html.setAttribute('data-bs-theme',          this.config['theme'])
    html.setAttribute('data-menu-color',        this.config['sidenav-color'])
    html.setAttribute('data-topbar-color',      this.config['topbar-color'])
    html.setAttribute('data-sidenav-size',      this.config['sidenav-size'])
    html.setAttribute('data-layout-position',   this.config['position'])
    html.setAttribute('data-layout-width',      this.config['width'])
    html.setAttribute('dir',                    this.config['dir'])
