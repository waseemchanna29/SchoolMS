        ...
        <div class="content-page">
            <div class="container-fluid">
                ...
                <div class="row g-3">
                            ...
                            <div class="shadow-sm h-100 card">
                                <div class="card-body">
                                    <div class="d-flex align-items-center mb-3">
                                        @if ($campus->logo)
                                            <img src="{{ asset('storage/' . $campus->logo) }}" width="48" height="48"
                                ...
                                <div class="d-flex gap-2 bg-transparent card-footer">
                                    <a href="{{ route('superadmin.campuses.show', $campus) }}"
                                        class="flex-fill btn-outline-primary btn btn-sm">View</a>
                                    <a href="{{ route('superadmin.campuses.edit', $campus) }}"
                                        class="flex-fill btn-outline-warning btn btn-sm">Edit</a>
                    ...
                    @empty
                        <div class="col-12">
                            <div class="alert alert-info">No campuses yet. <a
                                    href="{{ route('superadmin.campuses.create') }}">Create the first one</a>.</div>
                        </div>
                    @endforelse
                </div>
